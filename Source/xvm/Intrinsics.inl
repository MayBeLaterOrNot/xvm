...
XVM_INLINE Matrix4x4::Matrix4x4()
{
	r[0] = XVMIdentityR0;
	r[1] = XVMIdentityR1;
	r[2] = XVMIdentityR2;
...
XVM_INLINE Vec2 XVM_CALLCONV operator+(const Vec2& v1, const Vec2& v2)
{
...
XVM_INLINE Quaternion XVM_CALLCONV operator*(Quaternion q, float scalar)
{
	// q = [s, v]
	// λ = [λ, 0]
	// λq = [λ, 0][s, v]
...
XVM_INLINE Quaternion XVM_CALLCONV operator*(float scalar, Quaternion q)
{
	// scalar multiplication is commutative
	return q * scalar;
}
XVM_INLINE Matrix4x4 XVM_CALLCONV operator*(Matrix4x4 m, float scalar)
{
...
XVM_INLINE Matrix4x4 XVM_CALLCONV operator*(float scalar, Matrix4x4 m)
{
	// scalar multiplication is commutative
	return m * scalar;
}
