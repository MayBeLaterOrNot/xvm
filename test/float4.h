...
TEST(float4, intrinsics_clamp)
{
	float4 v1(2.0f);
	float4 v2(-1.0f, 2.0f, 0.25f, 0.5f);

	float4 result1 = clamp(v1, 0.0f, 1.0f);
	float4 result2 = clamp(v2, 0.0f, 1.0f);
