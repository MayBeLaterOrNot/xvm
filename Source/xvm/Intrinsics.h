...
Vec2 XVM_CALLCONV		operator+(const Vec2& v1, const Vec2& v2);
...
Vec3 XVM_CALLCONV		operator*(Vec3 v1, Vec3 v2);
Vec4 XVM_CALLCONV		operator*(Vec4 v1, Vec4 v2);
Quaternion XVM_CALLCONV operator*(Quaternion q1,
								  Quaternion q2); // Quaternion product
Quaternion XVM_CALLCONV operator*(Quaternion q, float scalar);
Quaternion XVM_CALLCONV operator*(float scalar, Quaternion q);
Matrix4x4 XVM_CALLCONV	operator*(Matrix4x4 m, float scalar);
Matrix4x4 XVM_CALLCONV	operator*(float scalar, Matrix4x4 m);
Matrix4x4 XVM_CALLCONV	operator*(Matrix4x4 m1, Matrix4x4 m2);
